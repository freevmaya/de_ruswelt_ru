...
require jet_reviews()->plugin_path( 'includes/updater/class-jet-reviews-base-update.php' );
 ...
 * @since 1.0.0
 */
class Jet_Reviews_Plugin_Update extends Jet_Reviews_Base_Update {
...
if ( ! function_exists( 'jet_reviews_updater' ) ) {
	function jet_reviews_updater() {
		return new Jet_Reviews_Plugin_Update();
	}
}
