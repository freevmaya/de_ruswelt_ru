...
if ( ! class_exists( 'MPack_Wizard_Child_API' ) ) {

	/**
	 * Define MPack_Wizard_Child_API class
	 */
	class MPack_Wizard_Child_API {
...
/**
 * Returns instance of MPack_Wizard_Child_API
 *
 * @param  int    $template_id Template ID from templatemonster.com.
 * @param  string $order_id    Order ID from user order details.
 * @return object
 */
function mpack_child_api( $id = null, $slug = null, $name = null ) {
	return MPack_Wizard_Child_API::get_instance( $id, $slug, $name );
}
