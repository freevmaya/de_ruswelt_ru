	...
	class Jet_Blog {
		...
		public function init() {
			...
			if ( is_admin() ) {
				...
				require $this->plugin_path( 'includes/updater/class-jet-blog-plugin-changelog.php' );

				jet_blog_plugin_changelog()->init( array(
					'name'     => 'JetBlog For Elementor',
					'slug'     => 'jet-blog',
					'version'  => $this->get_version(),
					'author'   => '<a href="https://zemez.io/zemezjet/">Zemez</a>',
					'homepage' => 'https://crocoblock.com/plugins/jetblog/',
					'banners'  => array(
