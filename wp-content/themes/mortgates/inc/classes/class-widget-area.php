...
if ( ! class_exists( 'Mortgates_Widget_Area' ) ) {

	/**
	 * Class Mortgates_Widget_Area.
	 */
	class Mortgates_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'mortgates_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'mortgates_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'mortgates_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function mortgates_widget_area() {
		return Mortgates_Widget_Area::get_instance();
	}

	mortgates_widget_area();
}
