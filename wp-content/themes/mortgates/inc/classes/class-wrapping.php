 ...
 */
add_filter( 'template_include', array( 'Mortgates_Wrapping', 'wrap' ), 99 );
add_filter( 'mortgates_wrap_base', 'mortgates_wrap_base_cpts' );
 ...
 */
function mortgates_template_path() {
	return Mortgates_Wrapping::$main_template;
}
 ...
 */
function mortgates_template_base() {
	return Mortgates_Wrapping::$base;
}

if ( ! class_exists( 'Mortgates_Wrapping' ) ) {
	...
	class Mortgates_Wrapping {
		...
		/**
		 * Initialize new instance of Mortgates_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'mortgates_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Mortgates_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function mortgates_wrap_base_cpts( $templates ) {
