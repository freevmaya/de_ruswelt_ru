...
if ( ! class_exists( 'Mortgates_Contact_Information_Widget' ) ) {

	/**
	 * Class Mortgates_Contact_Information_Widget.
	 */
	class Mortgates_Contact_Information_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an contact-information.', 'mortgates' );
			$this->widget_id          = 'mortgates_contact_information_widget';
			$this->widget_name        = esc_html__( 'Contact Information', 'mortgates' );
			...
			$this->settings           = array(
				...
				'contact_information' => array(
					'type'         => 'repeater',
					'add_label'    => esc_html__( 'Add Contact Information', 'mortgates' ),
					'title_field'  => 'value',
					'hidden_input' => true,
					'fields'       => array(
						'icon'  => array(
						...
						'value' => array(
							...
							'id'          => 'value',
							'name'        => 'value',
							'placeholder' => esc_html__( 'Value', 'mortgates' ),
							'label'       => esc_html__( 'Value', 'mortgates' ),
						),
					),
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			$template = mortgates_get_locate_template( 'inc/widgets/contact-information/views/contact-information-view.php' );
...
add_action( 'widgets_init', 'mortgates_register_contact_information_widget' );
/**
 * Register contact information widget.
 */
function mortgates_register_contact_information_widget() {
	register_widget( 'Mortgates_Contact_Information_Widget' );
}
