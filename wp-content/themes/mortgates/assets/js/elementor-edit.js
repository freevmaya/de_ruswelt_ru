( function( $, data ) {
	...
	var mortgatesElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, mortgatesElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, mortgatesElementor.initCb );
		},
	...
	mortgatesElementor.init();

}( jQuery, window.mortgatesEditData ) );
