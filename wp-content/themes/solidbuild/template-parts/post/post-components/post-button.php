...
$btn_visible = get_theme_mod( 'blog_read_more_btn', solidbuild_theme()->customizer->get_default( 'blog_read_more_btn' ) );
$btn_text    = get_theme_mod( 'blog_read_more_text', solidbuild_theme()->customizer->get_default( 'blog_read_more_text' ) );
