 ...
 */
add_filter( 'template_include', array( 'Solidbuild_Wrapping', 'wrap' ), 99 );
add_filter( 'solidbuild_wrap_base', 'solidbuild_wrap_base_cpts' );
 ...
 */
function solidbuild_template_path() {
	return Solidbuild_Wrapping::$main_template;
}
 ...
 */
function solidbuild_template_base() {
	return Solidbuild_Wrapping::$base;
}

if ( ! class_exists( 'Solidbuild_Wrapping' ) ) {
	...
	class Solidbuild_Wrapping {
		...
		/**
		 * Initialize new instance of Solidbuild_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'solidbuild_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Solidbuild_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Solidbuild_Wrapping();
		}
	}
}
 ...
 */
function solidbuild_wrap_base_cpts( $templates ) {
