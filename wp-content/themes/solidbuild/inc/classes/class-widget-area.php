...
if ( ! class_exists( 'Solidbuild_Widget_Area' ) ) {

	/**
	 * Class Solidbuild_Widget_Area.
	 */
	class Solidbuild_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'solidbuild_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'solidbuild_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'solidbuild_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function solidbuild_widget_area() {
		return Solidbuild_Widget_Area::get_instance();
	}

	solidbuild_widget_area();
}
