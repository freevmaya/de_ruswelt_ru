...
add_filter( 'tm_testimonials_pagination_args', 'solidbuild_tm_testimonials_pagination_args', 10, 2 );

// Add template to tm-testimonials templates list.
add_filter( 'tm_testimonials_templates_list', 'solidbuild_add_template_to_tm_testimonials_templates_list' );

// Change testimonials archive page template.
add_filter( 'tm_testimonials_archive_template_args', 'solidbuild_tm_testimonials_archive_template_args' );

// Add custom class at title wrap if invert
add_filter( 'tm_testimonials_title_format', 'solidbuild_tm_testimonials_add_invert_class_at_title_wrap', 10, 3 );
 ...
 * @return array
 */
function solidbuild_tm_testimonials_pagination_args( $pagination_args, $args ) {
 ...
 * @return array
 */
function solidbuild_add_template_to_tm_testimonials_templates_list( $tmpl_list ) {
 ...
 * @return array
 */
function solidbuild_tm_testimonials_archive_template_args ( $args = array() ) {
 ...
 * @return string
 */
function solidbuild_tm_testimonials_add_invert_class_at_title_wrap( $wrap, $inner, $args ) {
