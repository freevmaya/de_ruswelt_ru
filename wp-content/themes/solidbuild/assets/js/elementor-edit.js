( function( $, data ) {
	...
	var solidbuildElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, solidbuildElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, solidbuildElementor.initCb );
		},
	...
	solidbuildElementor.init();

}( jQuery, window.solidbuildEditData ) );
